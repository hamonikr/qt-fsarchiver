...
public:
    ...
    void setupUi(QDialog *treeview_dialog)
    {
        ...
        pushButton_treeview_2->setObjectName(QStringLiteral("pushButton_treeview_2"));
    ...
    void retranslateUi(QDialog *treeview_dialog)
    {
        ...
        pushButton_treeview_2->setText(QApplication::translate("treeview_dialog", "a", Q_NULLPTR));
    } // retranslateUi
