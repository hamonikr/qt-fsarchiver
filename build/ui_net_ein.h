...
public:
    ...
    void setupUi(QDialog *Eingabe_Net)
    {
        ...
        pushButton_net_2->setObjectName(QStringLiteral("pushButton_net_2"));
    ...
    void retranslateUi(QDialog *Eingabe_Net)
    {
        ...
        chk_datesave->setToolTip(QApplication::translate("Eingabe_Net", "Username and password will be saved.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label->setText(QApplication::translate("Eingabe_Net", "Computers that can be reached in the network:", Q_NULLPTR));
        ...
        pushButton_net_2->setText(QApplication::translate("Eingabe_Net", "n1", Q_NULLPTR));
    } // retranslateUi
