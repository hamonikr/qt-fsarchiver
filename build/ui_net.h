...
public:
    ...
    void setupUi(QDialog *Dialog_Net)
    {
        ...
        bt_treeWiget_2->setObjectName(QStringLiteral("bt_treeWiget_2"));
        ...
        pushButton_folder_free_2->setObjectName(QStringLiteral("pushButton_folder_free_2"));
    ...
    void retranslateUi(QDialog *Dialog_Net)
    {
        ...
        label_folder->setText(QApplication::translate("Dialog_Net", "Name of the backup file:", Q_NULLPTR));
        pushButton_partition->setText(QApplication::translate("Dialog_Net", "S", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_Partition->setToolTip(QApplication::translate("Dialog_Net", "Select the partition to back up or write back to.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_Partition->setText(QApplication::translate("Dialog_Net", "Existing partitions/directories:", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("Dialog_Net", "Planned action:", Q_NULLPTR));
        rdBt_saveFsArchiv->setText(QApplication::translate("Dialog_Net", "Save par&tition\n"
"with fs-archiver", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        pushButton_restore->setText(QApplication::translate("Dialog_Net", "Write back partition", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        label_folder_free->setToolTip(QApplication::translate("Dialog_Net", "Directory in which the partition is backed up or from which the recovery file is selected.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        chk_Beschreibung->setText(QApplication::translate("Dialog_Net", "Notes on the backup", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chk_overwrite->setToolTip(QApplication::translate("Dialog_Net", "Identical backup files are overwritten without prior consultation.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chk_overwrite->setText(QApplication::translate("Dialog_Net", "overwrite existing backup.", Q_NULLPTR));
        chk_split->setText(QApplication::translate("Dialog_Net", "Split archive , specified size:", Q_NULLPTR));
...
"backup key", Q_NULLPTR));
        ...
        chk_path->setText(QApplication::translate("Dialog_Net", "Writing a backup back to the original path.", Q_NULLPTR));
...
"transmission:", Q_NULLPTR));
        ...
        pushButton_partition_2->setText(QApplication::translate("Dialog_Net", "2", Q_NULLPTR));
        bt_treeWiget_2->setText(QString());
        label->setText(QApplication::translate("Dialog_Net", "Compression\n"
"setting:", Q_NULLPTR));
        label_4->setText(QApplication::translate("Dialog_Net", "File name of the backup:", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        pushButton_save->setText(QApplication::translate("Dialog_Net", "Save partition", Q_NULLPTR));
    } // retranslateUi
