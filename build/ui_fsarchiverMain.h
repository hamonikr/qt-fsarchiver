...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_partition_2->setObjectName(QStringLiteral("pushButton_partition_2"));
        pushButton_partition_2->setGeometry(QRect(260, 430, 20, 20));
        pushButton_folder_2 = new QPushButton(centralwidget);
        pushButton_folder_2->setObjectName(QStringLiteral("pushButton_folder_2"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_Information->setText(QApplication::translate("MainWindow", "&Information qt-fsarchiver", Q_NULLPTR));
        ...
        action_partition_save_net->setText(QApplication::translate("MainWindow", "&Save a partition on network", Q_NULLPTR));
        action_partition_restore_net->setText(QApplication::translate("MainWindow", "Restore &a partition on network", Q_NULLPTR));
        ...
        action_Restore_directories_from_network->setText(QApplication::translate("MainWindow", "Restoring directories over a network.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_Partition->setToolTip(QApplication::translate("MainWindow", "Select the partition to be backed up or written back.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_Partition->setText(QApplication::translate("MainWindow", "Existing partitions:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_folder->setToolTip(QApplication::translate("MainWindow", "Directory where the backup file is written or directory where the recovery file is stored.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        pushButton_save->setText(QApplication::translate("MainWindow", "Save partition", Q_NULLPTR));
        pushButton_partition->setText(QApplication::translate("MainWindow", "1", Q_NULLPTR));
...
"setting:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chk_Beschreibung->setToolTip(QApplication::translate("MainWindow", "Notes about the backup are written to a file.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chk_Beschreibung->setText(QApplication::translate("MainWindow", "Notes on the backup", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chk_overwrite->setToolTip(QApplication::translate("MainWindow", "An existing backup file with the same name is overwritten without confirmation.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chk_overwrite->setText(QApplication::translate("MainWindow", "overwrite existing backup.", Q_NULLPTR));
        chk_split->setText(QApplication::translate("MainWindow", "Split archive , specified size:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"backup key", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chk_pbr->setToolTip(QApplication::translate("MainWindow", "PBR is the first block of a bootable partition.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        groupBox->setTitle(QApplication::translate("MainWindow", "Planned action:", Q_NULLPTR));
...
"with fsarchi&ver", Q_NULLPTR));
        ...
        pushButton_partition_2->setText(QApplication::translate("MainWindow", "2", Q_NULLPTR));
