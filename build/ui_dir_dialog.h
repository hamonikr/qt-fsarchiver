...
public:
    ...
    void setupUi(QWidget *dir_dialog)
    {
        ...
        bt_dir->setObjectName(QStringLiteral("bt_dir"));
    ...
    void retranslateUi(QWidget *dir_dialog)
    {
        ...
        bt_save->setToolTip(QApplication::translate("dir_dialog", "Starting a Backup or Restoring a Directory. ", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bt_save->setText(QApplication::translate("dir_dialog", "Save/restore directory", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("dir_dialog", "Select the directory that is to be backed up or written back.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("dir_dialog", "Saved directory", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("dir_dialog", "Directory to which the directory backup is written or from which the recovery file is read.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        chk_overwrite->setToolTip(QApplication::translate("dir_dialog", "Identical backup files are overwritten without prior consultation.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chk_path->setText(QApplication::translate("dir_dialog", "Writing a backup back to the original path.", Q_NULLPTR));
