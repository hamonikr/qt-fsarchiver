...
"compression:", Q_NULLPTR));
        ...
        chk_file->setText(QApplication::translate("setting_dialog", "Overwrite existing files by default", Q_NULLPTR));
        chk_tip->setText(QApplication::translate("setting_dialog", "Activate notes for backup  by default", Q_NULLPTR));
        chk_folder->setText(QApplication::translate("setting_dialog", "Directories write back\n"
"to the original location by default", Q_NULLPTR));
        ...
        chk_datesave->setText(QApplication::translate("setting_dialog", "Save network input data", Q_NULLPTR));
        ...
        chk_ssh->setText(QApplication::translate("setting_dialog", "Display note for access to network computers", Q_NULLPTR));
        chk_sshfs->setText(QApplication::translate("setting_dialog", "Displaying a note about mounting the network computer", Q_NULLPTR));
        chk_prg->setText(QApplication::translate("setting_dialog", "Display notes on how to use the program qt-fsarchiver", Q_NULLPTR));
