...
public:
    ...
    void retranslateUi(QWidget *clone_dialog)
    {
        ...
        groupBox->setTitle(QApplication::translate("clone_dialog", "Planned action:", Q_NULLPTR));
        ...
        pushButton_folder_2->setText(QApplication::translate("clone_dialog", "f", Q_NULLPTR));
